  ...
  if (error) {
    return (
      <div className="flex h-screen w-screen flex-col items-center justify-center bg-gray-100 p-8 text-center">
        ...
        <button onClick={() => router.push('/upload')} className="mt-6 flex items-center gap-2 rounded-(--radius-control) bg-blue-600 px-4 py-2 text-white hover:bg-blue-500 transition-colors">
    ...
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800">
      <header className="bg-white shadow-md">
        <div className="container mx-auto flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
          <button onClick={() => router.push('/globe')} className="flex items-center gap-2 text-sm text-gray-600 hover:text-blue-600 transition-colors">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button size="sm" variant="secondary" icon={<FiMapPin />} onClick={() => router.push('/explore')}>
              2D Map
            </Button>
          </div>
        </div>
